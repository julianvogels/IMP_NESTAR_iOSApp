...
- (void)viewDidLoad
{
    ...
    _pageTitles = @[@"The IMP NESTAR Project", @"Participate in Experiments", @"Science!", @"View experiment results"];
...
- (TutorialContentViewController *)viewControllerAtIndex:(NSUInteger)index
{
    ...
    tutorialContentViewController.imageFile = self.pageImages[index];
...
- (IBAction)dismissTutorial:(id)sender {
    // TBD: Go to User Registration Screen
